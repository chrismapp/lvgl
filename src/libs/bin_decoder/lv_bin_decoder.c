...
#if LV_BIN_DECODER_RAM_LOAD
        else if (cf == LV_COLOR_FORMAT_ARGB8888 || cf == LV_COLOR_FORMAT_XRGB8888 || cf == LV_COLOR_FORMAT_RGB888 || cf == LV_COLOR_FORMAT_RGB565 || cf == LV_COLOR_FORMAT_RGB565A8 || cf == LV_COLOR_FORMAT_ARGB8565)
        {
                                    ...
                                    const lv_area_t *full_area, lv_area_t *decoded_area)
{
    ...
    bool supported = LV_COLOR_FORMAT_IS_INDEXED(cf) || cf == LV_COLOR_FORMAT_ARGB8888 || cf == LV_COLOR_FORMAT_XRGB8888 || cf == LV_COLOR_FORMAT_RGB888 || cf == LV_COLOR_FORMAT_RGB565 || cf == LV_COLOR_FORMAT_ARGB8565 || cf == LV_COLOR_FORMAT_RGB565A8;
    if (!supported)
    {
    ...
    if (cf == LV_COLOR_FORMAT_ARGB8888 || cf == LV_COLOR_FORMAT_XRGB8888 || cf == LV_COLOR_FORMAT_RGB888 || cf == LV_COLOR_FORMAT_RGB565 || cf == LV_COLOR_FORMAT_ARGB8565)
    {
...
static lv_result_t decompress_image(lv_image_decoder_dsc_t *dsc, const lv_image_compressed_t *compressed)
{
    ...
    else if (compressed->method == LV_IMAGE_COMPRESS_LZ4)
    {
        ...
        {
            LV_LOG_WARN("Decompress failed: %" LV_PRId32 ", got: %d", out_len, len);
            lv_draw_buf_destroy(decompressed);
            return LV_RESULT_INVALID;
        }
#else
